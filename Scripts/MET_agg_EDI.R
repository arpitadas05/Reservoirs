...
###1) Justification for using panel temp linear model from 2015 to substitute erroneous data
#Plot Air Temp vs. Panel Temp
...
###2) Compare observed met data with NDLAS ###
...
>>>>>>> 976ed1fc8141435a4162a3b0ef161593f3a69c55
...
######MORE SINE CURVE MAYBE I CAN MAKE THIS WORK########
#1. Basic sine curve
