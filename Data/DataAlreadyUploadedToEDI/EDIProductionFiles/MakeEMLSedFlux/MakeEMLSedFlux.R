...
#in this case, our directory is Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux
...
template_core_metadata(path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                 license = "CCBY",
                 file.type = ".txt",
                 write.file = TRUE)

template_table_attributes(path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                       data.path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                       data.table = "sedflux.csv",
                       write.file = TRUE)


#we want empty to be true for this because we don't include lat/long
#as columns within our dataset but would like to provide them
template_geographic_coverage(path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                          data.path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                          data.table = "sedflux.csv",
                          empty = TRUE,
                          write.file = TRUE)
...
#Maddy needs to be listed several times; she has to be listed separately for her roles as
...
template_categorical_variables(path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                               data.path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
                               write.file = TRUE)
...
#copy-paste the bounding_boxes.txt file (or geographic_coverage.txt file) that is Reservoir group specific into your working directory
...
# Run this function
make_eml(
  path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
  data.path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
  eml.path = "C:/Users/Mary Lofton/Documents/Github/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLSedFlux",
  dataset.title = "Sediment flux data for Krueger et al., 2019 from Falling Creek Reservoir in Vinton, Virginia, USA 2018",
  temporal.coverage = c("2018-xx-xx", "2018-xx-xx"),
  maintenance.description = 'completed',
  data.table = "sedflux.csv",
  data.table.description = "FCR sediment flux dataset",
  user.id = 'carylab6',
  user.domain = 'EDI',
...
############SHOULD WE USE DIFFERENT CREDENTIALS FOR THIS PUB?
