...
toPlot <- catdata_adj%>%
  filter(DateTime>as.Date("2019-09-01"),
         DateTime<as.Date("2019-10-04"))

toPlot <- catdata_adj%>%
  filter(DateTime>as.Date("2019-08-05 12:45:00"),
         DateTime<as.Date("2019-08-15 12:40:00"))

plot(as.POSIXct(toPlot$DateTime), toPlot$RDOsat_percent_9_adjusted, type = "l", xlab = "", ylab = "DO (mg/L)")
lines(as.POSIXct(toPlot$DateTime), toPlot$RDOsat_percent_9, col = "red")
...
# NOTE THAT WE USED BOTH TO DECIDE WHEN TO CHANGE
# FLAG ANY SOMEWHAT SUSPECT AREAS IN ADDITION TO CHANGING THE WORST PARTS
# REMOVE DATA SURROUNDING CLEANINGS AND FLAG
