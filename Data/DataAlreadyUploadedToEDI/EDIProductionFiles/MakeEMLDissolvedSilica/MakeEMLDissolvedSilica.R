...
# read in chl data
silica <- read.csv('./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica/silica_master_df.csv')
...
template_core_metadata(path = "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica",
                 license = "CCBY",
                 file.type = ".txt",
                 write.file = TRUE)

template_table_attributes(path = "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica",
...
template_geographic_coverage(path = "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica",
                          data.path = "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica",
...
template_categorical_variables(path = "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica",
                               data.path = "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLDissolvedSilica",
                               write.file = TRUE)
