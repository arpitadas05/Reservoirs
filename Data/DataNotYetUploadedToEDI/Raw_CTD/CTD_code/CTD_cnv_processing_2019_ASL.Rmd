...
DATE_TEXT <- "29-Jun-2020" #format should be "01-Aug-2019"
SITE <- "fcr50"
SAMPLER <- "ASL"
...
REP <- "b" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
